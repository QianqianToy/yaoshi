! function(t, e, a, n) {
	...
	t.extend(i.prototype, {
		...
		add_cart_buttons: function() {
			var t = this;
			t.cart.parent().append('<button class="' + t.settings.cart + '-clear">清空订单</button>'), t.cart.parent().append('<button type="submit" class="' + t.settings.cart + '-checkout">提交订单</button>'), t.clear_cart(), t.checkout_button()
		},
		checkout: function() {
			var e, a = this,
				n = {
			...
			t.extend(n, a.settings.paypal), i.attr("action", "E:/UserData/My Documents/HBuilderProject/MoBan/login.jsp"), i.attr("method", "post"), i.attr("target", "_top");
